---
name: app-coding-skills-object-storage-pipeline
description: >-
  Used when building object-storage ingestion and retrieval modules for web applications with signed URLs and metadata workflows.
---
