---
name: app-coding-skills-video-streaming
description: >-
  Used when designing or building a web-based video streaming platform. Covers
  ingest protocols, transcoding pipelines, adaptive delivery (HLS/DASH),
  real-time chat, CDN distribution, storage strategy, auth, and scalability. Use
  when architecting a live or on-demand streaming service, choosing ingest vs
  delivery protocols, designing a transcoding pipeline, planning CDN/storage, or
  building a real-time interaction layer (chat, notifications).
---
