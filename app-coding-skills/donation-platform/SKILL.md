---
name: app-coding-skills-donation-platform
description: >-
  Used when building donation platform software on the web. Donation platform for campaign funding, recurring pledges, receipts, and impact reporting workflows.
---
