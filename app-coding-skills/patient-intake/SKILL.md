---
name: app-coding-skills-patient-intake
description: >-
  Used when building patient intake software on the web. Patient intake workflow for demographics, consent, insurance details, and pre-visit data quality checks.
---
...
Patient intake workflow for demographics, consent, insurance details, and pre-visit data quality checks.

## When to use

- You need a dedicated product workflow for **patient intake**, not a generic SaaS shell.
