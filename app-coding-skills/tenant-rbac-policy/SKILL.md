---
name: app-coding-skills-tenant-rbac-policy
description: >-
  Used when building a tenant-scoped RBAC policy module for web applications with evolving role and permission rules.
---
