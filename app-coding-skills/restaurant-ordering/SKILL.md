---
name: app-coding-skills-restaurant-ordering
description: >-
  Used when building restaurant ordering software on the web. Restaurant ordering platform for menu/cart/checkout, order lifecycle, and fulfillment channel routing.
---
...
Restaurant ordering platform for menu/cart/checkout, order lifecycle, and fulfillment channel routing.

## When to use

- You need a dedicated product workflow for **restaurant ordering**, not a generic SaaS shell.
