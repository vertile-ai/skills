---
name: app-coding-skills-live-chat
description: >-
  Used when building live chat software on the web. Live chat messaging system with tenant/user rooms, agent assignment, and transcript persistence.
---
