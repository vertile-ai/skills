---
name: app-coding-skills-tenant-portal
description: >-
  Used when building tenant portal software on the web. Tenant self-service portal for requests, documents, payments, and operational status tracking.
---

# Tenant Portal playbook

## Purpose / category boundary

Tenant self-service portal for requests, documents, payments, and operational status tracking.

## When to use

- You need a dedicated product workflow for **tenant portal**, not a generic SaaS shell.
