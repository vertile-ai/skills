---
name: app-coding-skills-knowledge-base
description: >-
  Used when building knowledge base software on the web. Knowledge base platform for authored docs, revisions, publication workflow, and discoverable search.
---
...
Knowledge base platform for authored docs, revisions, publication workflow, and discoverable search.

## When to use

- You need a dedicated product workflow for **knowledge base**, not a generic SaaS shell.
