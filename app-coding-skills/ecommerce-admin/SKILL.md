---
name: app-coding-skills-ecommerce-admin
description: >-
  Used when building ecommerce admin software on the web. E-commerce admin console for catalog, order, fulfillment, discount, and refund operations.
---

# Ecommerce Admin playbook

## Purpose / category boundary

E-commerce admin console for catalog, order, fulfillment, discount, and refund operations.

## When to use

- You need a dedicated product workflow for **ecommerce admin**, not a generic SaaS shell.
