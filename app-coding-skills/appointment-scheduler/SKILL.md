---
name: app-coding-skills-appointment-scheduler
description: >-
  Used when building appointment scheduler software on the web. Appointment scheduler for time-bound services with availability, buffers, no-show handling, and rebooking.
---

# Appointment Scheduler playbook

## Purpose / category boundary

Appointment scheduler for time-bound services with availability, buffers, no-show handling, and rebooking.

## When to use

- You need a dedicated product workflow for **appointment scheduler**, not a generic SaaS shell.
