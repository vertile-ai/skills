---
name: app-coding-skills-domain-event-pubsub
description: >-
  Used when building domain-event pub/sub modules for web applications with versioned contracts and idempotent consumers.
---
