---
name: app-coding-skills-booking-engine
description: >-
  Used when building booking engine software on the web. Booking engine for reservable resources with slot generation, conflict prevention, and hold/confirm flows.
---

# Booking Engine playbook

## Purpose / category boundary

Booking engine for reservable resources with slot generation, conflict prevention, and hold/confirm flows.

## When to use

- You need a dedicated product workflow for **booking engine**, not a generic SaaS shell.
