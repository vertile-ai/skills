---
name: app-coding-skills-async-job-orchestration
description: >-
  Used when building async job orchestration modules for web applications with retries, idempotency, and compensation-safe workflows.
---
