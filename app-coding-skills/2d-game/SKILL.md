---
name: app-coding-skills-2d-game
description: >-
  Used when developing web based 2D game. Covers dependencies, code patterns,
  module design, WASM/Worker/WebGL trade-offs, and browser APIs for all six web
  2D game drives: control, system, rule, content, physics, and network. Use when
  designing or building any browser-based 2D game, choosing a renderer, planning
  a sim or netcode architecture, or deciding on saves, assets, and tooling.
---
