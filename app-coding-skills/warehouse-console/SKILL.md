---
name: app-coding-skills-warehouse-console
description: >-
  Used when building warehouse console software on the web. Warehouse console for receiving, put-away, pick-pack-ship, and exception processing.
---

# Warehouse Console playbook

## Purpose / category boundary

Warehouse console for receiving, put-away, pick-pack-ship, and exception processing.

## When to use

- You need a dedicated product workflow for **warehouse console**, not a generic SaaS shell.
