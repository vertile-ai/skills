---
name: app-coding-skills-route-planner
description: >-
  Used when building route planner software on the web. Route planning software for optimizing stop sequences and travel windows under operational constraints.
---

# Route Planner playbook

## Purpose / category boundary

Route planning software for optimizing stop sequences and travel windows under operational constraints.

## When to use

- You need a dedicated product workflow for **route planner**, not a generic SaaS shell.
