---
name: app-coding-skills-incident-console
description: >-
  Used when building incident console software on the web. Incident response workspace focused on alert triage, severity routing, on-call ownership, and timeline evidence.
---

# Incident Console playbook

## Purpose / category boundary

Incident response workspace focused on alert triage, severity routing, on-call ownership, and timeline evidence.

## When to use

- You need a dedicated product workflow for **incident console**, not a generic SaaS shell.
