---
name: app-coding-skills-crm-workspace
description: >-
  Used when building crm workspace software on the web. CRM workspace for contact/account timelines, activity capture, and pipeline handoff workflows.
---

# Crm Workspace playbook

## Purpose / category boundary

CRM workspace for contact/account timelines, activity capture, and pipeline handoff workflows.

## When to use

- You need a dedicated product workflow for **crm workspace**, not a generic SaaS shell.
