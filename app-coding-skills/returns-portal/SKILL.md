---
name: app-coding-skills-returns-portal
description: >-
  Used when building returns portal software on the web. Returns portal for RMA creation, eligibility rules, reverse-logistics state, and refund closure.
---

# Returns Portal playbook

## Purpose / category boundary

Returns portal for RMA creation, eligibility rules, reverse-logistics state, and refund closure.

## When to use

- You need a dedicated product workflow for **returns portal**, not a generic SaaS shell.
