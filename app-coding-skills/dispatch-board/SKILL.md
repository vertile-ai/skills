---
name: app-coding-skills-dispatch-board
description: >-
  Used when building dispatch board software on the web. Real-time dispatch board for allocating jobs to agents/vehicles with live state and exception handling.
---

# Dispatch Board playbook

## Purpose / category boundary

Real-time dispatch board for allocating jobs to agents/vehicles with live state and exception handling.

## When to use

- You need a dedicated product workflow for **dispatch board**, not a generic SaaS shell.
