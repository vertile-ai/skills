---
name: app-coding-skills-marketplace-seller
description: >-
  Used when building marketplace seller software on the web. Marketplace seller workspace for listing, inventory, order handling, payout visibility, and disputes.
---

# Marketplace Seller playbook

## Purpose / category boundary

Marketplace seller workspace for listing, inventory, order handling, payout visibility, and disputes.

## When to use

- You need a dedicated product workflow for **marketplace seller**, not a generic SaaS shell.
