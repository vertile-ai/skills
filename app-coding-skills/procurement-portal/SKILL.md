---
name: app-coding-skills-procurement-portal
description: >-
  Used when building procurement portal software on the web. Procurement operations workspace for requisitions, approvals, vendor interactions, and PO state transitions.
---

# Procurement Portal playbook

## Purpose / category boundary

Procurement operations workspace for requisitions, approvals, vendor interactions, and PO state transitions.

## When to use

- You need a dedicated product workflow for **procurement portal**, not a generic SaaS shell.
