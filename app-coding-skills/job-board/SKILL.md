---
name: app-coding-skills-job-board
description: >-
  Used when building job board software on the web. Job board product for role publishing, candidate discovery, and application intake at scale.
---
