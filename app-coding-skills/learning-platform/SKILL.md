---
name: app-coding-skills-learning-platform
description: >-
  Used when building learning platform software on the web. Learning platform for curriculum delivery, enrollment progression, assessment, and completion analytics.
---

# Learning Platform playbook

## Purpose / category boundary

Learning platform for curriculum delivery, enrollment progression, assessment, and completion analytics.

## When to use

- You need a dedicated product workflow for **learning platform**, not a generic SaaS shell.
