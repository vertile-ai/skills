---
name: app-coding-skills-ops-control-center
description: >-
  Used when building ops control center software on the web. Operational command center for multi-tenant B2B systems: incidents, alerts, SLA breaches, and escalation state.
---

# Ops Control Center playbook

## Purpose / category boundary

Operational command center for multi-tenant B2B systems: incidents, alerts, SLA breaches, and escalation state.

## When to use

- You need a dedicated product workflow for **ops control center**, not a generic SaaS shell.
