---
name: app-coding-skills-telehealth-portal
description: >-
  Used when building telehealth portal software on the web. Telehealth portal for appointment intake, virtual visit orchestration, and clinician/patient workflow sync.
---

# Telehealth Portal playbook

## Purpose / category boundary

Telehealth portal for appointment intake, virtual visit orchestration, and clinician/patient workflow sync.

## When to use

- You need a dedicated product workflow for **telehealth portal**, not a generic SaaS shell.
...
Domain event intake -> validation against policy/availability -> dispatch/execution -> reconciliation.

Recommended entity backbone:

- `tenant`
- `telehealth_portal_record`
- `workflow_state`
- `activity_event`
- `integration_event`
...
- Put compliance/business rules in a dedicated policy layer with deterministic tests.
...
- Do not hardcode vertical rules inside UI components.
