---
name: app-coding-skills-exam-proctoring
description: >-
  Used when building exam proctoring software on the web. Exam proctoring system for exam session control, identity checkpoints, violation events, and audit review.
---

# Exam Proctoring playbook

## Purpose / category boundary

Exam proctoring system for exam session control, identity checkpoints, violation events, and audit review.

## When to use

- You need a dedicated product workflow for **exam proctoring**, not a generic SaaS shell.
