---
name: app-coding-skills-kitchen-display
description: >-
  Used when building kitchen display software on the web. Kitchen display system for ticket sequencing, prep station routing, and expo/ready state transitions.
---

# Kitchen Display playbook

## Purpose / category boundary

Kitchen display system for ticket sequencing, prep station routing, and expo/ready state transitions.

## When to use

- You need a dedicated product workflow for **kitchen display**, not a generic SaaS shell.
