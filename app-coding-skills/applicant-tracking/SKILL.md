---
name: app-coding-skills-applicant-tracking
description: >-
  Used when building applicant tracking software on the web. Applicant tracking system with stage transitions, interviewer coordination, and hiring decision logs.
---

# Applicant Tracking playbook

## Purpose / category boundary

Applicant tracking system with stage transitions, interviewer coordination, and hiring decision logs.

## When to use

- You need a dedicated product workflow for **applicant tracking**, not a generic SaaS shell.
