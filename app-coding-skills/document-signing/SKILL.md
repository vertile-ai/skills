---
name: app-coding-skills-document-signing
description: >-
  Used when building document signing software on the web. Document signing workflow with template generation, signer state tracking, and tamper-evident audit logs.
---

# Document Signing playbook

## Purpose / category boundary

Document signing workflow with template generation, signer state tracking, and tamper-evident audit logs.

## When to use

- You need a dedicated product workflow for **document signing**, not a generic SaaS shell.
