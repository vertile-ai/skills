---
name: app-coding-skills-customer-support
description: >-
  Used when building customer support software on the web. Customer support desk for ticket intake, assignment, SLA control, and resolution playbooks.
---
...
Customer support desk for ticket intake, assignment, SLA control, and resolution playbooks.

## When to use

- You need a dedicated product workflow for **customer support**, not a generic SaaS shell.
