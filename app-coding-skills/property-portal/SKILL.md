---
name: app-coding-skills-property-portal
description: >-
  Used when building property portal software on the web. Property operations portal for lease lifecycle, work orders, notices, and tenant communication artifacts.
---

# Property Portal playbook

## Purpose / category boundary

Property operations portal for lease lifecycle, work orders, notices, and tenant communication artifacts.

## When to use

- You need a dedicated product workflow for **property portal**, not a generic SaaS shell.
